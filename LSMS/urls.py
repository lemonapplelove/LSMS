...
urlpatterns = patterns('',
    ...
    url(r'^accounts/modifyPassword', 'LSMS.views.password_modify'),
    url(r'^accounts/resetPassword', 'LSMS.views.password_reset'),
    url(r'^accounts/logout', 'LSMS.views.logout'),
    
    url(r'^s/(\d+)/$', 'LSMS.views.student_read'),
    url(r'^s/(\d+)/modify/$', 'LSMS.views.student_modify'),
    ...
    url(r'^s/(\d+)/score/term/(\d+)/', 'LSMS.views.score_read'),
    ...
    url(r'^class/(\d+)/modify$', 'LSMS.views.class_modify'),
